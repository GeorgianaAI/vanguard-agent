    ...
    >
      ...
      >
        <div className="mb-4 flex items-center justify-between gap-2">
          <h3 className="flex min-w-0 items-center gap-2 text-[11px] font-black uppercase tracking-[0.2em] text-slate-400">
            <BarChart3
              className={`h-4 w-4 shrink-0 ${standby ? "text-slate-600" : "text-emerald-500"}`}
            />{" "}
            NIST: MEASURE
          </h3>
          <span
            className={`shrink-0 font-mono text-[9px] ${standby ? "text-slate-600" : "text-emerald-500"}`}
          >
            {measure.mode}
          </span>
        </div>
        <div className="min-w-0 space-y-3">
          <div className="flex justify-between gap-2 text-[11px]">
            ...
            <span
              className={`shrink-0 font-mono text-[10px] tracking-widest ${standby ? "text-slate-600" : "text-emerald-400"}`}
            >
              {measure.value}
            </span>
          </div>
      ...
      >
        <div className="mb-4 flex items-center justify-between gap-2">
          <h3 className="flex min-w-0 items-center gap-2 text-[11px] font-black uppercase tracking-[0.2em] text-slate-400">
            <Settings2
              className={`h-4 w-4 shrink-0 ${standby ? "text-slate-600" : "text-cyan-500"}`}
            />{" "}
            NIST: MANAGE
          </h3>
          <span
            className={`shrink-0 font-mono text-[9px] ${standby ? "text-slate-600" : "text-cyan-500"}`}
          >
            {manage.mode}
          </span>
        </div>
        <div className="min-w-0 space-y-3">
          <div className="flex justify-between gap-2 text-[11px]">
            ...
            <span
              className={`shrink-0 font-mono text-[10px] tracking-widest ${standby ? "text-slate-600" : "text-cyan-400"}`}
            >
              {manage.value}
            </span>
          </div>
